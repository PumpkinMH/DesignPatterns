...
public class Police implements Observer {
  ...
  /**
   * Called by the subject. Stores each location, description, and accomplices in their respective
   * places with no repeats
   * 
  ...
  /**
   * Returns a log that shows every single location, note, and accomplice. All are grouped into
   * their respective category with no repeats.
   * 
