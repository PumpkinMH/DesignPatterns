...
public class Cartel implements Observer {
  ...
  /**
   * ArrayList of all the Sightings. A sighting is the location, notes, and accomplices all in one
   * object.
   */
  ...
  /**
   * Called by the Subject. Creates a new sighting with all of the parameters stored in it. Repeats
   * are allowed.
   * 
