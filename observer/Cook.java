...
public class Cook implements Subject {
    ...
    /**
     * Notifies all of the Observers that are registered by calling update() (called from enterSighting)
    ...
    /**
     * Sends the sighting to the Observers by notifying the Observers. 
     * The Strings are converted into an ArrayList by using comma separated values with spaces.
     * @param location String represenation of the location
     * @param description String representation of the description
     * @param accomplices String representation of the accomplices. Use a comma and a space to separate the accomplices
     */
